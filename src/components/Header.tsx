...
export function Header({ onSettingsClick }: HeaderProps) {
  ...
  return (
    <header className="h-16 border-b border-border/40 flex items-center justify-between px-6 bg-background/80 backdrop-blur-md sticky top-0 z-20 transition-all duration-300">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 ml-2 px-2.5 py-1 rounded-full bg-muted/40 border border-border/30 backdrop-blur-sm">
          {isLoading ? (
      ...
      <Button 
        ...
        className="h-9 w-9 rounded-full hover:bg-muted/60 hover:text-primary transition-all duration-300 hover:rotate-90"
      >
